...
> 🚀 **最新版本 cn-0.1.13**: OpenRouter集成与真实数据Web界面！新增DeepSeek R1免费模型支持、真实股价数据展示、个股强弱指标分析！
>
> 🆕 **全新功能**: OpenRouter DeepSeek R1免费模型 | 真实AkShare数据 | 个股强弱分析 | 交互式Web界面 | 技术指标可视化
> 
...
### 🆓 OpenRouter DeepSeek R1 免费集成

- **零成本AI分析**: 使用OpenRouter免费的DeepSeek R1模型 (`deepseek/deepseek-r1-0528:free`)
- **完整LLM支持**: 新增OpenRouter适配器，支持60+免费模型
- **简单配置**: 只需注册OpenRouter获取免费API Key即可使用
- **智能切换**: 自动检测并使用最佳可用模型

### 📊 真实数据Web界面

- **AkShare集成**: 获取真实A股股价数据，告别模拟数据
- **实时价格**: 显示真实的股票价格和涨跌幅信息
- **历史K线**: 前复权价格数据，确保技术分析准确性
- **容错机制**: 多重备用方案，确保数据获取稳定性

### 🎯 个股强弱指标 (自研)

- **相对强弱分析**: 股价相对大盘指数的表现评估
- **多指数对比**: 支持上证指数、深证成指、沪深300等
- **动态评分**: 0-100评分系统，直观展示强弱程度
- **趋势判断**: 自动识别"强于大盘"、"弱于大盘"、"与大盘同步"

### 📈 技术指标可视化

- **20+技术指标**: MA、RSI、MACD、布林带、KDJ等完整技术分析
